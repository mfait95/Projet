...
Pour exécuter cet exemple, vous devez exécuter :
...
Notez que cet exemple peut créer des ressources qui peuvent coûter de l'argent. Lancez `terraform destroy` lorsque vous n'avez pas besoin de ces ressources.

<!-- DÉBUT DU CROCHET DE DOCS PRE-COMMIT-TERRAFORM -->
## Requirements
